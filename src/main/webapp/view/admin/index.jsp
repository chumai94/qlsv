									...
									<div class="row mt-2">
										...
										<div class="form-group col-md-5 row">
											<div class="col-md-4" style="margin-top: -60px;">
												<a
													href="${pageContext.request.contextPath}/admin/add-giaovien"
										...
										<tr>
											...
											<td><a
												...
												class="text-danger"><i class="fa-solid fa-trash"></i></a> <c:choose>
													<c:when test="${user.lockStatus}">
														<a
															href="${pageContext.request.contextPath}/admin/unlock-giaovien?id=${user.id}"
															class="text-danger"><i class="fa-solid fa-lock"></i></a>
													</c:when>
													<c:otherwise>
														<a
															href="${pageContext.request.contextPath}/admin/lock-giaovien?id=${user.id}"
