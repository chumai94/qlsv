								...
								<form>
									<div class="row align-items-end">
										<div class="form-group col-md-6">
											<label for="inputEmail4">Mã/Tên/chu kỳ môn</label> <input
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-primary"
												...
												data-cycle="${subject.cycle.name}"
												data-description="${subject.description}"
												data-createat="${subject.createAt}"
												data-lastmodified="${subject.lastmodified}"
												data-status="${subject.status ? 'Đã kết thúc' : 'Đang hoạt động'}">
												Chi tiết</button>
										</td>
									</tr>
								</c:forEach>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-header">
											<h5 class="modal-title" id="myModalLabel">Thông tin môn
												học</h5>
										...
										<div class="modal-body">
											<p>
												<strong>Mã môn:</strong> <span id="modal-subject-id"></span>
											</p>
											<p>
												<strong>Tên môn:</strong> <span id="modal-subject-name"></span>
											</p>
											<p>
												<strong>Chu kỳ:</strong> <span id="modal-subject-cycle"></span>
											</p>
											<p>
							...
							myModalElement
									.addEventListener(
											...
											function(event) {
												...
												var create = dayjs(createAt).format('DD/MM/YYYY');
												var lastmodified = dayjs(last).format('DD/MM/YYYY');
												...
												document
														.getElementById('modal-subject-cycle').textContent = cycle;
												document
